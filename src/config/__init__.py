...
# EMA historical forecast output (generated by EMA repo's generate_historical_forecasts.py)
EMA_HISTORICAL_FORECASTS_DIR = (
    Path.home() / "projects" / "energy_market_analysis" / "output" / "DE" / "historical_forecasts"
)
